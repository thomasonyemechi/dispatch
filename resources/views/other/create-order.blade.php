...
@section('page_content')
    ...
    <div class="booking-step-2 d-flex flex-column vh-100">
        <form action="/staff/add-customer" method="POST" id="order-form" enctype="multipart/form-data">
            @csrf
            <div class="vh-100 my-auto overflow-auto p-3">
                ...
                <div class="mb-3">
                    <label class="form-label text-muted mb-1 small">Service Name <span class="text-danger">*</span></label>
                    <div class="input-group border-bottom">
                        <span class="input-group-text bg-transparent rounded-0 border-0 text-muted px-0"
                ...
                <div class="mb-3">
                    <label class="form-label text-muted mb-1 small">Assign Designer <span
                            class="text-danger">*</span></label>
                    <div class="input-group border-bottom">
                        <span class="input-group-text bg-transparent rounded-0 border-0 text-muted px-0"
                            id="basic-addon1"><i class="bx bxs-user bx-sm"></i></span>
                        <select name="" id=""
                            class="form-control  bg-transparent rounded-0 border-0 text-muted px-0">
                ...
                <div class="mb-3">
                    <label class="form-label text-muted mb-1 small">Upload Files <span class="text-danger">*</span></label>
                    <div class="input-group border-bottom">
                        <span class="input-group-text bg-transparent rounded-0 border-0 text-muted px-0"
                ...
                <div class="mb-3">
                    <label class="form-label text-muted mb-1 small">Receiver's Address <span class="text-danger">*</span>
                    </label>
                    <div class="input-group border-bottom">
                        <span class="input-group-text bg-transparent rounded-0 border-0 text-muted px-0"
                ...
                <div class="mb-3 row ">
                    <div class="col-6">
                        <label class="form-label text-muted mb-1 small">Total Price <span
                                class="text-danger">*</span> </label>
                        <div class="input-group border-bottom">
                            <span class="input-group-text bg-transparent rounded-0 border-0 text-muted px-0"

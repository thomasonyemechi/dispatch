    ...
    <div class="vh-100 my-auto overflow-auto">
        ...
        <div class="bg-primary rounded-top-4 mt-5 pt-5   shadow text-center profile-content">
            ...
            <div class="mb-3">
                <div>
                    ...
                    <p class="text-white-50"><i class="bx bx-calendar me-2"></i>Added {{ date('j M, Y H:i a', strtotime($customer->created_at)) }} | by
                        {{ $customer->user->name }} 
                    </p>
                </div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item col" role="presentation">
                        <button class="nav-link active" id="summary-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="summary-tab-pane" aria-selected="false" tabindex="-1"> <i class="bx bxs-list-ol" ></i> ORDERS</button>
                    </li>
                    <li class="nav-item col" role="presentation">
                        <button class="nav-link" id="calender-tab" data-bs-toggle="tab"
                            data-bs-target="#calender-tab-pane" type="button" role="tab"
                            aria-controls="calender-tab-pane" aria-selected="false" tabindex="-1"> <i class="bx bxs-paper-plane" ></i> MESSAGE</button>
                    </li>
        ...
        <div>
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade active show" id="summary-tab-pane" role="tabpanel" aria-labelledby="summary-tab"
                    tabindex="0">
                    <div class="p-3">
